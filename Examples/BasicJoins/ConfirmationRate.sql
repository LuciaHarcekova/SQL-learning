...
requested confirmation messages. The confirmation rate of a user that did not request any confirmation messages i
s 0. Round the confirmation rate to two decimal places.
...
SELECT user_id, Round(Avg(If(Confirmations.action='confirmed',1,0)),2) AS confirmation_rate
FROM Signups
